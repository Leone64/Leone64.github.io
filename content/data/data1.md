...
The parameters of the clouds in the catalogue are available in this [repository](https://github.com/Leone64/catalogue_dustclouds), as ```cloud-data.csv```. See the ```README.md``` there for further information on the individual files.
